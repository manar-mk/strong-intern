...
export const requests = {
  ...
  popularTvShows: `https://api.themoviedb.org/3/tv/popular?api_key=${IMDB_API_KEY}&language=en-US`,
  nowPlayingMovies: `https://api.themoviedb.org/3/movie/now_playing?api_key=${IMDB_API_KEY}&language=en-US`,
